 ...
 * @author saim_
 */
public class LabGUI_123 extends javax.swing.JFrame {

    /**
     * Creates new form LabGUI_123
     */
    String fileName;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LabGUI_123.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LabGUI_123().setVisible(true);
            }
        });
    }
